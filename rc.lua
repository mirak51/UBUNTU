...
awful.key({ modkey,           }, "i", function () awful.spawn("brave-browser") end,
...
--awful.spawn.with_shell("sh /opt/urserver/urserver")
--awful.util.spawn("numlockx on")
awful.spawn.with_shell("nitrogen --restore")

 
 awful.spawn.easy_async("numlockx on")
-- awful.spawn.easy_async("/home/mirak/karim-remote")

--awful.spawn.easy_async("/opt/urserver/urserver")
